...
unsigned DataParser::ParseReceivedData(char* str, unsigned len, std::vector<ReceivePacket> &dataPacketVec){
...
int DataParser::ParseReceivedData2(char* str, unsigned len, std::vector<ReceivePacket> &dataPacketVec)
{
    if(str == NULL)
    {
